...
public class EncryptedPropertySourceLoader implements PropertySourceLoader, PriorityOrdered {
   ...
   // private static final String ENCRYPTION_PASSWORD_NOT_SET = "test";
    ...
    private String getPasswordFromEnvAndSystemProperties() {
        String password = "test";//System.getenv(ENCRYPTION_PASSWORD_ENVIRONMENT_VAR_NAME_UNDERSCORE);
        if (password == null) {
    ...
    public List<PropertySource<?>> load(String name, Resource resource) throws IOException {
        ...
        if (!props.isEmpty()) {
            ...
            sources.add(new EncryptablePropertiesPropertySource(name, props, this.encryptor));
            return sources;
        }
