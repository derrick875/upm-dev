...
public class CvmCheckRequest implements Loggable{
	...
	private CvmCheckTransactionDomainData transactionDomainData;
	...
	public CvmCheckTransactionDomainData getTransactionDomainData() {
		return transactionDomainData;
	}

	public void setTransactionDomainData(CvmCheckTransactionDomainData transactionDomainData) {
