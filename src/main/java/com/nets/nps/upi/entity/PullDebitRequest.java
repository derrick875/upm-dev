...
public class PullDebitRequest implements Loggable{
	...
	private PullDebitRequestTransactionDomainData transactionDomainData;
	...
	public PullDebitRequestTransactionDomainData getTransactionDomainData() {
		return transactionDomainData;
	}

	public void setTransactionDomainData(PullDebitRequestTransactionDomainData transactionDomainData) {
