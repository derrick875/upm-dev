...
public class CvmCheckResultRequest  implements Loggable{
	...
	@JsonProperty("transaction_domain_data_object")
	private CvmCheckResultTransactionDomainData transactionDomainData;
	...
	public CvmCheckResultTransactionDomainData getTransactionDomainData() {
		return transactionDomainData;
	}

	public void setTransactionDomainData(CvmCheckResultTransactionDomainData transactionDomainData) {
